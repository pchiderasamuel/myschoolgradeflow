      ...
      <div className="auth-layout">
        <div className="auth-side">
          ...
          <p className="auth-side-sub">
            ...
            Your school admin has shared this link ΓÇö no school PIN required.
          </p>

          <div style={{ display: "flex", flexDirection: "column" }}>
            <div className="auth-feature">
              <div className="auth-feature-icon" style={{ color: "#2563eb" }}>ΓÜí</div>
              Direct staff access ΓÇö no PIN needed
            </div>
            <div className="auth-feature">
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleLogin} style={{ marginTop: "1.75rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <button type="submit" className="auth-btn" disabled={loading} style={{ marginTop: "0.5rem" }}>
              {loading ? <><Spinner /> Signing inΓÇª</> : <>Sign In</>}
            </button>
