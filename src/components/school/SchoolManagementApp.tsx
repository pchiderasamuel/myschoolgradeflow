                ...
                <Card className="overflow-hidden">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <Sel label="Class" value={scoreForm.studentClass} onChange={(e: any)=>setScoreForm(f=>({...f,studentClass:e.target.value,subject:"",studentName:""}))}><option value="">Select class</option>{(auth.user?.assignedClasses?.length?auth.user.assignedClasses:ALL_CLASSES).map((c: string)=><option key={c}>{c}</option>)}</Sel>
